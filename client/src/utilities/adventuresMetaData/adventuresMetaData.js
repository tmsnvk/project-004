...
const adventuresMetaData = [
  {
    ...
    storyOne: { title: "Tutorial", link: "tutorial", arc: "zero", code: "a0s1", available: "true" },
  ...
  },
  {
    ...
    storyOne: { title: "To One Last New Beginning", link: "to_one_last_new_beginning_a1s1", arc: "one", code: "a1s1", available: "true" },
  ...
  },
  {
    ...
    storyOne: { title: "Greenskins, Greenskins everywhere", link: "greenskins_greenskins_everywhere_a2s1", arc: "two", code: "a2s1", available: "false" },
  ...
  },
  {
    ...
    storyOne: { title: "How to Lose an Empire", link: "how_to_lose_an_empire_a3s1", arc: "three", code: "a3s1", available: "false" },
  ...
  },
  {
    ...
    storyOne: { title: "Wild Elvish Sorcerers", link: "wild_elvish_sorcerers_a4s1", arc: "four", code: "a4s1", available: "false" },
