...
import { TileContainer } from "components/shared/tile-related";
import { HorizontalLine, LoadingSpinner } from "components/shared/general";
import { IconDark, IconLight } from "components/shared/styled-icons";
...
const ListAchievements = ({ dataSet, displayAchievements, elapsedLoadingTime, loadingSpinner, showSpinnerIfGreaterThanTime }) => {
  ...
  return (
    <ComponentContainer>
      {loadingSpinner && elapsedLoadingTime > showSpinnerIfGreaterThanTime ? <LoadingSpinner loadingMessage={"The Tower librarians are retriving the requested data from their Archives."} /> : null}
