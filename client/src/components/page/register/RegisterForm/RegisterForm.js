    ...
    <ComponentContainer>
      <Form method="POST" action="/user/register" id="user-register" onSubmit={handleSubmit(onSubmit)}>
        <FormWrapper>
          ...
          {errors.registerUsername && <ErrorMessageWrapper errorMessage={errors.registerUsername.message} />}
          ...
          {errors.registerPassword && <ErrorMessageWrapper errorMessage={errors.registerPassword.message} />}
          ...
          <Input 
            ...
            ref={register({
              required: { value: true, message: "PASSWORD verification is required; enter the same password twice." },
